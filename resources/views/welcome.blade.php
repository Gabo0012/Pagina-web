...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/inicio.css')}}">
...
<body>
    <header class="header">
        <div class="menu container">
            <a href="Pagina principal.html" class="inicio">
            ...
            <nav class="navbar">
                <ul>
                    ...
                    <li class=""><a class="nav-link" href="{{ route('login') }}">Login</a></li>
    ...
    <footer class="footer container">
        ...
        <ul>
            ...
            <li><a href="Politica/Politica.html">Politicas de la pagina</a></li>
        ...
        <script src="{{ asset('assets/inicio.js')}}">
